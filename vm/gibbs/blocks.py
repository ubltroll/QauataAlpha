...
class GibbsBlock(BaseBlock):
    transaction_builder = GibbsTransaction
    ...
    def __init__(self,
                 ...
                 transactions: Sequence[GibbsSignedTransactionAPI] = None,
    ...
    #
    @classmethod
    def from_header(cls, header: BlockHeaderAPI, chaindb: ChainDatabaseAPI) -> "GibbsBlock":
        """
