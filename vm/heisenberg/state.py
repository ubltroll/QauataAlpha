...
from .computation import HeisenbergComputation
...
from .validation import (
    ...
    validate_qauata_transaction_vm,
...
class HeisenbergTransactionExecutor(BaseTransactionExecutor):
...
class HeisenbergState(BaseState):
    computation_class: Type[ComputationAPI] = HeisenbergComputation
    transaction_context_class: Type[TransactionContextAPI] = HeisenbergTransactionContext
    account_db_class: Type[AccountDatabaseAPI] = AccountDB
    transaction_executor_class: Type[TransactionExecutorAPI] = HeisenbergTransactionExecutor
